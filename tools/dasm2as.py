#!/usr/bin/env python3
"""dasm2as.py -- convert Combat's DASM disassembly to Macroassembler AS syntax.
...
Combat's disassembly is DASM. Rather than fork the toolchain, convert the
source; the conversion is proved correct by `make verify-org`, which assembles
the result and requires it to be byte-identical to the cartridge dump.
