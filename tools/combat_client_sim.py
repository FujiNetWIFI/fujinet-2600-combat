#!/usr/bin/env python3
"""combat_client_sim.py -- two simulated consoles against a fresh relay.
...
Usage: combat_client_sim.py [--port 9639]
"""
...
def main():
    ...
    try:
        ...
        check(pa[4] == pb[4] == 5, "both get the variation the server was told")
