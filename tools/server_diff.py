...
server/combat_relay_server.py is canonical.  server/c/combat-relay is a C port
...
RELAY_C = os.path.join(REPO, "server", "c", "combat-relay")
RELAY_PY = os.path.join(REPO, "server", "combat_relay_server.py")
